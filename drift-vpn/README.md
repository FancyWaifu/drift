...
peers: 2
  9f76ea7164c11021  192.0.2.168:51820  state=established srtt=0.3ms stale=0s
    allowed_ips=["10.99.0.2/32"]  tx=85234 rx=12053
  21b17698b78592e1  192.0.2.168:51820  state=established srtt=0.5ms stale=0s
...
Note for the second peer above: `192.0.2.168` is the *hub's* IP — that's what mesh-only peers display as their `peer.addr`. The next-hop, not the destination's real address.
