...
impl Peer {
    ...
    /// via_bridges_auto = "104.166.196.243@<pub>"        # then the standard menu
    /// ```
...
"#,
    ...
    fn expand_via_bridges_auto_produces_nine_candidates() {
        let spec = format!("104.166.196.243@{}", BRIDGE_PUB_HEX);
...
public_key       = "{peer}"
allowed_ips      = ["10.0.0.2/32"]
via_bridges_auto = "udp://104.166.196.243@{bridge}"
"#,
            peer = PUB_HEX,
            bridge = BRIDGE_PUB_HEX,
        ));
...
public_key       = "{peer}"
allowed_ips      = ["10.0.0.2/32"]
via_bridges_auto = "104.166.196.243:51820@{bridge}"
"#,
            peer = PUB_HEX,
            bridge = BRIDGE_PUB_HEX,
        ));
...
via_bridges_auto = "104.166.196.243@{bridge}"
"#,
            peer = PUB_HEX,
            bridge = BRIDGE_PUB_HEX,
        ));
